...
class SolicitudSicretAdmin(admin.ModelAdmin):
    list_display = ("ticket_netcracker", "rbd", "nombre_escuela", "estado_enlace", "descripcion_falla", "creado_por", "creado_en")
    list_filter = ("estado_enlace", "descripcion_falla", "creado_en")
