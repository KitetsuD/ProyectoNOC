...
urlpatterns = [
    ...
    path("administracion/rbd/bajas/", views.admin_rbd_bajas, name="admin_rbd_bajas"),
    path("administracion/rbd/<int:servicio_id>/editar/", views.admin_rbd_editar, name="admin_rbd_editar"),
    path("administracion/rbd/<int:servicio_id>/dar-baja/", views.admin_rbd_dar_baja, name="admin_rbd_dar_baja"),
