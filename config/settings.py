...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-proyectonoc-dev-key-change-me")
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.notificaciones_operativas',
            ],
        },
    },
]
